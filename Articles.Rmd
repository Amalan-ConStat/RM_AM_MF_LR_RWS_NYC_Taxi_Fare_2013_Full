...
Combined_MSE[!(Combined_MSE$Subsample_Size %in% seq(100,100,100)),] %>%
  ...
  ggplot(.,aes(x=Subsample_Size,y=log(Sum_MSE),color=Model))+
...
ggsave(filename = "RWA_PR_NYCTaxiMedData.eps",device="eps",dpi=300,width = 8,height = 6,units = "in")
...
Combined_Accuracy[!(Combined_Accuracy$Subsample_Size %in% seq(100,100,100)),] %>%
  ...
  scale_x_continuous(labels =unique(Combined_Accuracy$Subsample_Size),
    ...
    theme_light()+
    xlab("r")+
    ylab("log(Average MSE for Y)")+#expand_limits(y = 0)+
...
ggsave(filename = "RWA_PR_NYCTaxiMedData_Accuracy.eps",device="eps",dpi=300,width = 8,height = 6,units = "in")
